module.exports = {
    ...
    arrHover: {
        ...
        arrSpecs: {
            fire: 'Släckbil',
            wasser_amount: 'liter vatten',
            elw: 'Brandbefäl',
            elw2: 'Räddningsledning',
            fire_investigation: 'Brandutredare',
            dlk: 'Lastväxlare',
            rtw: 'Intensivvårds ambulans',
            ktw: 'Ambulans',
            ...
            fbi_unit: 'SÖPO bil',
            fbi_investigation_unit: 'NOA',
            fbi_mobile_command: 'Nationalla insatsledningen',
            fbi_bomb_tech: 'Nationella bombskyddet',
            fbi_drone: 'SÄPO övervakningsdrönare',
            sheriff_unit: 'Sheriff Unit',
        },
    },
    enhancedMissingVehicles: {
        vehicle: 'Fordonstyp',
        missing: 'Saknas på uppdraget',
        driving: 'På väg',
        total: 'Behövs fortfarande',
        tip: {
            dragging: 'dra fönster',
            textMode: 'textläge on/off',
            minified: 'minimera',
            overlay: 'overlay',
            reload: 'ladda om',
            pushRight: 'visa denna låda ovanför fordonslistan',
            pushLeft: 'visa denna låda på dess orginalplats',
        },
        selected: 'Valt',
        foam: 'liter skum',
        water: 'liter vatten',
    ...
    tailoredTabs: {
        allTab: 'Alla',
        occupiedTab: 'Uppföljning',
        vehicleMissing: {
            title: 'Ett fordon är inte tillgängligt | Flera fordon är inte tillgängligt',
            text: 'Följande fordon finns bara på fliken ALLA:',
            hide: 'Dölj anteckningar',
            close: 'Dölj anteckning tills uppdatering',
        },
    },
    patientCollapse: {
        combis: 'Kombinationer',
        amount: 'Antal',
        summary: {
            total: 'patienter',
            treated: 'behandlas',
    ...
    hideVehicleList: {
        show: 'Visa fordonslistan',
        hide: 'Dölj fordonslistan',
    },
